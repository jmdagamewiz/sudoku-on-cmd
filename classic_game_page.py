...
def show_classic_game(puzzle_name, puzzle_grid):
    term = Terminal()
    ...
    while blanks > 0:
        ...
        frontend.show_title("Classic Mode")
    ...
    answer_location = backend.get_file_location("classic_puzzles_answers", answer_grid_name)
...
def play_classic_game(puzzle_name):
    ...
    show_classic_game(puzzle_name, puzzle_grid)
